...
data.frame(
  ...
  kable(booktabs = F, align = 'c', escape = F) %>% #format = latex
  kable_styling(full_width = F, font_size = 12, latex_options = 'striped') %>% #, latex_options = 'striped') %>%
  footnote(
    footnote_as_chunk = T,
    general_title = " ",
