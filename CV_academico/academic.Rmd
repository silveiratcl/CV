...
www: silveiratcl.github.io/site/
twitter: silveiratcl
github: silveiratcl 
...
tribble(
  ...
  "Informática para Internet", "2021-atual", "SENAC-SC", "Florianópolis (1000h)", 
  "Programming for Everybody (Getting Started with Python)", "2021-2021", "University of Michigan/Coursera", "on line (19h)",
...
Acesse meu [*CV Lattes*](http://lattes.cnpq.br/5960267776845701) para uma lista completa de publicações.
...
tribble(
   ~ Linguagens, ~ Estatítica, ~ Software, ~ Estudando,
  "R -- HTML -- CSS -- Markdown" ,
  "GLM -- Randon Forests -- Abordagens Multivariadas",
  "QGIS -- RStudio -- Visual Studio Code -- Inkscape -- Mendeley",
  "Javascript -- Python -- OpenDrift (Individual Based Moldelling) -- GIT -- Leaflet -- Markdown -- SQL"
) %>% 
...
data.frame(
  ...
  kable_styling(full_width = F, font_size = 12, latex_options = "hold_position") %>% #, latex_options = 'striped') %>%
  row_spec(0, bold = T, color = "#009acd") %>% 
  column_spec(column = 1:4, width = '3.75cm') %>% 
  footnote(
    footnote_as_chunk = T,
 ...
 # column_spec(column = 1:4, width = '2.8cm')# %>% 
 #row_spec(0, bold = T, color = "#009acd") %>% 
 #row_spec(1, bold = F, color = "#7f7f7f")# %>%   
